/**
 * TELA: CadastroConsultorScreen
 * 
 * FUNÇÃO:
 * Permite cadastrar um novo consultor com:
...
type CadastroConsultorScreenNavigationProp = DrawerNavigationProp<RootDrawerParamList, 'CadastroConsultor'>;

export default function CadastroConsultorScreen() {
  const navigation = useNavigation<CadastroConsultorScreenNavigationProp>();
  ...
  const handleSalvar = () => {
    ...
    console.log('Consultor cadastrado:', novoConsultor);
  ...
  // CORREÇÃO 3: useMemo para o Switch evitar re-renderização
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* CORREÇÃO 1: Cabeçalho com posição absoluta e paddingTop para a status bar */}
      <View style={[styles.header, { paddingTop: STATUS_BAR_HEIGHT + 8 }]}>
        ...
        <Text style={styles.headerTitle}>Novo Consultor</Text>
        <TouchableOpacity onPress={handleSalvar} style={styles.saveButton}>
          <Text style={styles.saveText}>Salvar</Text>
        </TouchableOpacity>
      </View>

      {/* Conteúdo com paddingTop para não ficar atrás do cabeçalho */}
      <KeyboardAvoidingView 
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          ...
          >
            ...
            <View style={styles.form}>
              ...
              {/* CORREÇÃO 3: Switch usando useMemo */}
            </View>
          </ScrollView>
        </TouchableWithoutFeedback>
      </KeyboardAvoidingView>
...
const styles = StyleSheet.create({
  ...
  // CORREÇÃO 1: Cabeçalho com posição absoluta
  header: {
    position: 'absolute',
    top: 0,
    left: 0,
